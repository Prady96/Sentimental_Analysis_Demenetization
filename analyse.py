...
parser = argparse.ArgumentParser(description = "Demonetization")
...
tweets=tweepy.Cursor(api.search,q="Demonetization", count=100, result_type="recent", include_entities=True, lang="en").items()
#
# Analyse tweets
